...
![chaxun2](../assets/jc5-cx-sqlname.JPG)
##<a name="load"/>生成数据库文件</a>
####下面我们学会将我们现有的xls表格数据导入到我们的数据库中，可看以下动画
![chaxun3](../assets/jc5-cx-xlstocsv.gif)
...
```
####最终效果
![chaxun5](../assets/jc5-cx-result.png)
